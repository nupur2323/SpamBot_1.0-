...
def calculate_metrics(y_test, Y_predicted, specificity=None, sensitivity=None):
	...
	for i in range(confusion_mat.shape[0]):
		...
		print(str(TP) + "\t" + str(FP) + "\t" + str(FN) + "\t" + str(TN) + "\tsensitivity: " + str(round(TP / (TP + FN), 2)) + "\tspecificity: " + str(round(TN / (TN + FP), 2)))
